...
-- Create a function 'get_fiscal_year' to get the fiscal year by passing the date
...
### Create a report of individual product sales (aggregated on a monthly basis at the product code level) for Chroma India customers for FY = 2021
...
### Stored Procedure: To determine the Market Badge

--  Write a stored procedure that can determine the market badge. i.e. if the total sold quantity > 5 million that market is considered "Gold" else "Silver"
...
### Write a stored procedure for getting the top n products in each division by their quantities sold in a given FY
...
### Retrieve the top 2 markets in every region by their gross sales amount in financial year 2021
